...
leaked_grads = torch.load("state_dicts/local_grads_client1_5c_10r_batch2.pt", weights_only=True)
...
save_image(image_tensor[0], "reconstructions/Infered_image100_2.png")
save_image(image_tensor[1], "reconstructions/Infered_image200_2.png")
print(infered_label)